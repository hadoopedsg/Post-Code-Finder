...
<html lang="en">
  <head>
    ...
    #bg { 
          background: url(post.jpg) no-repeat center center fixed; 
  ...
  <body>
      ...
      <div id="bg" class="container">
        ...
        <p style="color:white">Enter a partial address to get the postcode.</p>
          <div id="message"></div>
      <form>
  ...
  <button class="btn btn-primary" id="find-postcode">Submit</button>
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.2/js/bootstrap.min.js" integrity="sha384-vZ2WRJMwsjRMW/8U7i6PWi6AlO1L79snBrmgiDpgIWJ82z8eA5lenwvxbMV1PAh7" crossorigin="anonymous"></script>
      ...
      <script type="text/javascript">
        ...
        $.ajax({
            url: "https://maps.googleapis.com/maps/api/geocode/json?address=" + encodeURIComponent($("#address").val()) + "&key=AIzaSyBizlaotCvJFZ20DY52PCMhxE0Ewyf7U-Q",
            type: "GET",
